...
var gameMonitor = {
	...
	initListener : function(ctx){
		...
		WeixinApi.ready(function(Api) {   
            ...
            var wxData = {
                ...
                "link" : "http://chencunfen.com/h5/index.html",
                "desc" : "进击的河粉",
                "title" : "“抢陈村河粉 吃陈村河粉”"
            };
	...
	getScore : function(){
		...
		var user = 1;
		if(score==0){
			$('#scorecontent').html('真遗憾，您竟然<span class="lighttext">一碗</span>河粉都没有抢到！');
		...
		$('#scorecontent').html('您在<span id="stime" class="lighttext">2378</span>秒内抢到了<span id="sscore" class="lighttext">21341</span>碗河粉<br>超过了<span id="suser" class="lighttext">31%</span>的用户！');
		$('#stime').text(time);
		$('#sscore').text(score);
		$('#suser').text(user+'%');
		$('.btn1').text('请小伙伴吃河粉').removeClass('playagain').addClass('share');
	},
	isMobile : function(){
